                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 py-[60px] lg:pt-[100px]">
                        <div className="new-bn-text relative">
                            ...
                            <h1 data-aos="fade-right"
                                data-aos-offset="200"
                                data-aos-easing="ease-in-sine" className="text-[]">Webteck Best IT Solution 2024</h1>
                            <p data-aos="fade-right"
                                data-aos-offset="300">Energistically harness ubiquitous imperatives without state of the art collaboration and idea-sharing. Monotonectally parallel task cross-unit experiences and front-end.</p>
