...
export default function Home() {
    const PageMeta = 
        {
        title: "Social Media Marketing, Dubai - Daraluloom",
    ...
    const breadcrumbs = [
      ...
      const aboutItems = [
        { image: "/images/icons/check.svg", text: "Social Media Management" },
        { image: "/images/icons/check.svg", text: "Social Media Content Creation" },
        { image: "/images/icons/check.svg", text: "Social Media Campaign Management" },
        { image: "/images/icons/check.svg", text: "Social Media Community Management" },
        { image: "/images/icons/check.svg", text: "Social Media Advertising" },
      ];
    ...
    const whyusData = [
      {
        ...
        description:"Conduct research to understand brand objectives and target audience.",
        image:"/images/icons/strategy-1.svg",
      },
      {
        title:"Content Creation",
        description:"Craft engaging captions, images, videos, and stories tailored to each platform.",
        image:"/images/icons/writer.svg",
      },
      {
        title:"Monitoring and Optimization",
        description:"Continuously monitor performance metrics and optimize content for maximum engagement.",
        image:"/images/icons/monitor.svg",
      },
      {
        title:"Reporting and Analysis",
        description:"Provide regular reports and analysis to track progress and identify areas for improvement.",
        image:"/images/icons/reporting.svg",
      },
    ];
  ...
  return (
    ...
    <PageHead PageMeta={PageMeta} />
      ...
      <InnerBannerDesign
        ...
        image="/images/banner/smm-bg.jpg"
      />
       <OurEducational
          subtitle="What We Do" 
          title="Social Media Marketing Services" 
          paradescription="At our Social Media Agency, we specialize in two key areas to elevate your online presence: Social Media Management and Content Creation. Through strategic channel management and captivating content creation, we engage with your audience effectively, driving growth and brand awareness like never before."
          aboutItems={aboutItems} 
          imageSrc="/images/service/smm-2.png" 
          button={true}
        />
       ...
       <CtaBlock/>
        <WhyUs 
           ...
           content="Our approach to social media management is rooted in comprehensive strategies and creative content creation. We begin by understanding your brand objectives and target audience, conducting thorough research to map out effective strategies. From there, we develop engaging content tailored to each platform, ensuring consistent brand voice and message. Through continuous monitoring and optimization, we strive to maximize engagement and drive results for your brand." 
         />
